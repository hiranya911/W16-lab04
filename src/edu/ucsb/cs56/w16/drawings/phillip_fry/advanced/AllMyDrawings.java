...
public class AllMyDrawings
{
	...
	g2.draw(fT1);
	g2.setColor(new Color(0x8F00FF)); g2.draw(fT2);
	
	// @@@ FINALLY, SIGN AND LABEL YOUR DRAWING
	
	g2.setStroke(orig);
	g2.setColor(Color.BLACK); 
	g2.drawString("A few tanks by Phillip Fry", 20,20);
    }
	...
	Tank t1 = new Tank(100,250,50,75);
	g2.setColor(Color.CYAN); g2.draw(t1);
	...
	flagTank fT1 = new flagTank(50,350,40,75);
	flagTank fT2 = new flagTank(200,350,200,100);
	
	g2.draw(fT1);
	g2.setColor(new Color(0x8F00FF)); 
	
	// Rotate the second house 45 degrees around its center.
	Shape fT3 = ShapeTransforms.rotatedCopyOf(fT2, Math.PI/4.0);
	...
	Tank large = new Tank(100,50,225,150);
	flagTank smallCC = new flagTank(20,50,40,30);
