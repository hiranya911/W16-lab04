package edu.ucsb.cs56.w16.drawings.phillip_fry.simple;
...
/**
   ...
   @author Phillip Fry(fixed the snowmans's head)
...
{  
	...
	//final double snowManTopBottomX = 400;
	//final double snowManTopBottomY = 285;
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Phillip Fry drew the top circle", 20,20);
