package edu.ucsb.cs56.w16.drawings.sschwellenbach.simple;
...
/**
   ...
   @author Sierra Schwellenbach (fixed the snowmans's head)
...
{  
	...
	g2.draw(snowManTopCircle);
        ...
        g2.drawString("Snowman by a house, Sierra Schwellenbach", 20,20);
